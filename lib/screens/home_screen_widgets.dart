...
class RunTimeInfoCard extends TextCard1 {
  RunTimeInfoCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.access_time_outlined, title: t.meta.runDuration);
...
class MemoryInfoCard extends TextCard1 {
  MemoryInfoCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.memory, title: t.meta.memory);
...
class ConnectionsInfoCard extends TextCard1 {
  ConnectionsInfoCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.monitor_outlined, title: t.meta.connect);
...
class TrafficTotalInfoCard extends TextCard2Line {
  TrafficTotalInfoCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.data_saver_off, title: t.meta.trafficTotal);
...
class TrafficProxyInfoCard extends TextCard2Line {
  TrafficProxyInfoCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.data_saver_off, title: t.meta.trafficProxy);
...
class TrafficSpeedInfoCard extends TextCard2Line {
  TrafficSpeedInfoCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.speed, title: t.meta.netSpeed);
...
class _ProfileSubTrafficInfoState extends State<ProfileSubTrafficInfoCard> {
  ...
  Widget build(BuildContext context) {
    ...
    if (group != null && group.traffic != null) {
      ...
      Tuple2<bool, String> exp = group.traffic!.getExpireTime(
                  ...
                  children: [
                    ...
                    if (group.traffic != null) ...[
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [Text(expireTime, style: textStyle)],
                        ),
                      ),
                    ],
                  ],
  ...
  void onPress() async {
    ...
    List<Widget> widgets = [
      ...
      ListTile(
        title: Text("${t.meta.update} ${t.meta.profile}"),
        onTap: () async {
          Navigator.pop(context);
...
class BackupAndSyncCard extends TextCard0 {
  BackupAndSyncCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.cloud_sync_outlined, title: t.meta.backupAndSync);
...
class OutboundModeCard extends StatefulWidget {
  const OutboundModeCard({super.key, this.onChanged, this.focusNode});
...
class MyProfilesCard extends TextCard0 {
  MyProfilesCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.list_alt_outlined, title: t.meta.myProfiles);
...
class AddProfileCard extends TextCard0 {
  AddProfileCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.add_outlined, title: t.meta.addProfile);
...
class DiversionCard extends TextCard0 {
  DiversionCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.alt_route_outlined, title: t.meta.diversion);
...
class DiversionRulesCard extends TextCard0 {
  DiversionRulesCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.alt_route_outlined, title: t.meta.diversionRules);
...
class NetcheckCard extends TextCard0 {
  NetcheckCard({super.key, super.onPressed, super.onLongPress, super.focusNode})
    : super(icon: Icons.network_check_outlined, title: t.NetCheckScreen.title);
...
class SpeedTestCard extends TextCard0 {
  SpeedTestCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.speed_outlined, title: t.SettingsScreen.speedTest);
...
class MyLinkCard extends TextCard0 {
  MyLinkCard({super.key, super.onPressed, super.onLongPress, super.focusNode})
    : super(icon: Icons.link_outlined, title: t.SettingsScreen.myLink);
...
class AppleTVCard extends TextCard0 {
  AppleTVCard({super.key, super.onPressed, super.onLongPress, super.focusNode})
    : super(icon: Icons.live_tv_outlined, title: t.meta.appleTV);
...
class HtmlBoardCard extends TextCard0 {
  HtmlBoardCard({
    ...
    super.onLongPress,
    super.focusNode,
  }) : super(icon: Icons.dashboard_outlined, title: t.SettingsScreen.htmlBoard);
...
class NetShareCard extends TextCard0 {
  NetShareCard({super.key, super.onPressed, super.onLongPress, super.focusNode})
    : super(
